                ...
                <form>
                    <div className="form-group input-group">
                        <div className="input-group-prepend">
                            <span className="input-group-text"> <i aria-hidden className="fa fa-envelope"></i> </span>
                        </div>
                    ...
                    <div className="form-group input-group">
                        <div className="input-group-prepend">
                            <span className="input-group-text"> <i aria-hidden className="fa fa-lock"></i> </span>
                        </div>
